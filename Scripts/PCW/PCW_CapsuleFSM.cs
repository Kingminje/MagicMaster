...
public class PCW_CapsuleFSM : MonoBehaviour
{
    ...
    public PCW_CapsuleMovement _movement;

    public PCW_CapsuleCasting _casting;

    public Animator _animator;

    public PCW_EnemyHealth enemyHealth;
